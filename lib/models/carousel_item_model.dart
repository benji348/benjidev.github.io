  ...
  (index) => CarouselItemModel(
    text: Column(
      ...
      children: [
        ...
        const Text(
          'Software Developer, based in China origin from Congo',
        ...
        Wrap(
          children: [
            const Text(
              ...
              style:
                  TextStyle(color: kCaptionColor, fontSize: 18.0, height: 1.5),
            ),
            GestureDetector(
        ...
        MouseRegion(
          ...
          child: Container(
            ...
            child: TextButton(
              autofocus: true,
              onPressed: () => customDialog('Link Me!', 'Subject',
                  'Enter your message', FlutterIcons.handshake_faw5, 'Link Me'),
              child: const Text(
                'Let\'s get in',
                style: TextStyle(
                    color: Colors.white,
